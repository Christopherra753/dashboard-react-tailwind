  ...
  return (
    <div className='bg-secondary-100 p-8 rounded-xl shadow-2xl w-auto max-w-lg md:w-full'>
      ...
      <form className='mb-8'>
        ...
        <div>
          <button type='submit' className='bg-primary text-black uppercase font-bold w-full py-3 px-4 rounded-full duration-150'>Enviar</button>
        </div>
      </form>
      <div className='flex flex-col items-center justify-center gap-3'>
        <span className='flex items-center gap-2'>
          ¿Ya tienes cuenta?
          <Link className='text-primary/90 hover:text-gray-100 transition-colors' to='/auth'>Enviar Instrucciones</Link>
        </span>
        <span className='flex items-center gap-2'>
          ¿No tienes cuenta?
          <Link className='text-primary/90 hover:text-gray-100 transition-colors' to='/auth/register'>Registrate</Link>
        </span>
      </div>
    </div>
  )
